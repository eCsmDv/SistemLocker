...
from Arin_al.class_SystemaLocker import *
from Arin_al.class_retornar import *
from class_SystemaLocker import SistemaLocker
from class_retornar import RetornarMenu

menu = """
    +----+-----------------------------------+
    |----+   Sistema de Lockers de Entrega   |
    +----+-----------------------------------+
    |  1 | Entrega                           |
    |  2 | Retirada                          |
    |  3 | Configuração                      |
